export const en = {
  ...
  dashboard: {
    ...
    cardNewLeads: "New leads",
    cardHotLeads: "Hot leads",
    cardHumanReplies: "Waiting for reply",
    cardFollowUpsDue: "Follow-ups due",
    cardHotRadar: "Hot Radar leads",
    cardPostsScheduled: "Posts scheduled",
    cardPostsAwaitingApproval: "Posts awaiting approval",
    cardPostsFailed: "Posts failed",
    greetingMorning: "Good morning,",
    greetingAfternoon: "Good afternoon,",
    greetingEvening: "Good evening,",
    thingsNeedAttention: "Things that need your attention today:",
    allClear: "Nothing urgent right now — all clear.",
    cardCustomers: "Customers & Opportunities",
    cardBookings: "Today & Bookings",
    cardMarketing: "Marketing",
    actionReview: "Review now",
    actionOpenPlanner: "Open Planner",
    actionManagePosts: "Manage posts",

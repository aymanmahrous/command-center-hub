-- Fix enqueue_publish_job: provider_external_id stores batch provider tag at creation,
-- not a Meta post ID. Only block enqueue when published_at is set or a published receipt exists.

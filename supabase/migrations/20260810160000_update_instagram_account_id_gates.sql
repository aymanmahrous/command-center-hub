-- Minimal Instagram account-ID gate update for verified @relaxfixuae
-- Replace explicit Instagram account validation ID:
--   previous: 17841439747493221
--   current:  17841400516601494
...
begin
  ...
  if p_account_id <> '17841400516601494' then
...
begin
  ...
  if p_platform <> 'instagram' or p_account_id <> '17841400516601494' then
...
begin
  ...
  if not found
     ...
     or v_auth.page_id <> '17841400516601494' then
...
begin
  ...
  inner join public.owner_publish_authorizations opa
    ...
    and opa.page_id = '17841400516601494'

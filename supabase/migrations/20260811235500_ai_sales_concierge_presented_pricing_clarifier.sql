-- Phase 6C fix: stop sticky identical pricing replies in presented_pricing.
-- When already in presented_pricing and the inbound message is not pricing/booking/handoff,
-- reply with a short clarifier instead of resending the full pricing block.
-- No schema changes. Outbound settings unchanged.

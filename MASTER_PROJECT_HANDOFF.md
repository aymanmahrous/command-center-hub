...
في 2026-08-04 اعتمد المالك خطة النشر اليومية طويلة المدى الموضحة في القسم 14. هذا اعتماد للخطة وحفظ لها، وليس تفويضًا لتجاوز اختبار Facebook أو تفعيل Production قبل بوابات الأمان.

## 10. الخطوة الحالية (NEXT)

إغلاق مراجعة الحماية لمسار Facebook Controlled Publishing Test، ثم تنفيذ نشر عنصر Facebook المصرح به فقط عبر المسار المعتمد بعد الموافقات المطلوبة، وتقديم: Facebook Post ID، رابط المنشور، وقت النشر الفعلي، execution ID، وreceipt status. عند غموض النتيجة لا يُعاد النشر.
...
- الخطة اليومية في القسم 14 لا تُفعَّل على Production قبل إغلاق Facebook، ثم Instagram، ثم اعتماد وجدولة محتوى الأسبوع الأول وفق ترتيب القسم 6.
...
## 14. OWNER-APPROVED DAILY PUBLISHING STRATEGY — LOCKED 2026-08-04

### معدل النشر المعتمد

- منشور رئيسي واحد يوميًا على Facebook وInstagram بعد جاهزية كل منصة.
- Stories شبه يومية عند توفر مادة مناسبة ومعتمدة.
- فيديو قصير / Reel كل 3 أيام تقريبًا، بمتوسط 2 إلى 3 فيديوهات أسبوعيًا.
- لا زيادة إلى منشورين أو أكثر يوميًا إلا بعد مراجعة أداء أول 30 يومًا وقرار إداري موثق.

### التوزيع الأسبوعي

- 4 منشورات تعليمية أو حل مشكلة.
- 2 فيديو Reel على الأقل، ويمكن رفعها إلى 3 عند توفر مادة أصلية جيدة.
- 1 منشور ثقة أو خدمة أو عرض غير مدفوع.

### قواعد الحماية

- لا نشر تلقائي لمحتوى غير معتمد.
- لا Retry تلقائي عند غموض النتيجة.
- لا نشر مكرر.
- لا Boost ولا إعلانات ضمن هذه الخطة.
- كل نشر فعلي يجب أن ينتج Receipt قابلًا للمراجعة.
- أي نتيجة غامضة توقف العنصر وتحتاج مراجعة بشرية.
- لا يُلمس Instagram قبل إغلاق اختبار Facebook الآمن ثم اختبار Instagram المستقل.
- التفعيل الكامل يبدأ فقط بعد إغلاق Facebook، ثم Instagram، ثم اعتماد وجدولة محتوى الأسبوع الأول، ثم اعتماد الوسائط حسب ترتيب القسم 6.

### حالة الاعتماد

`STRATEGY_APPROVED_AND_SAVED — PRODUCTION_ACTIVATION_PENDING_SAFETY_GATES`

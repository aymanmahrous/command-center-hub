...
لا يوجد عنصر Instagram معتمد حاليًا للاختبار المُتحكَّم فيه. الخطوة التالية: إنشاء دفعة 10 أيام من Content Growth Hub، اعتماد **منشور Instagram واحد** فقط، ثم تشغيل n8n للنشر الحي (بدون Boost أو إعلانات أو إعادة نشر تلقائي).
